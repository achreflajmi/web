...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <a href="C:\Users\user\Desktop\project web\login\Login_v1\index.html"
        class="book-a-table-btn scrollto d-none d-lg-flex">Se connecter</a>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          <h1>Bienvenue à <span>DisTunis</span></h1>
          <h2>Votre guide partout !</h2>

          <div class="btns">
            <a href="C:\Users\user\Desktop\project web\login\Login_v1\index.html"
              class="btn-menu animated fadeInUp scrollto">Se connecter</a>
            <a href="C:\Users\user\Desktop\project web\sing up\colorlib-regform-8\index.html"
              class="btn-book animated fadeInUp scrollto">S'inscrire</a>
          </div>
        </div>
  ...
  <main id="main">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            ...
            <ul>
              <li><i class="bi bi-check-circle"></i>
                <p class="rania"> Nous sommes une équipe passionnée de cinéma, musique, littérature,
                  arts visuels et bien d'autres formes d'expression artistique. Notre objectif est de fournir une
                  expérience divertissante et éducative à nos visiteurs en leur offrant un contenu de qualité et en les
                  aidant à découvrir de nouvelles choses intéressantes.

                  Nous sommes fiers de proposer une large gamme de contenus, allant des critiques de films et de livres
                  aux interviews d'artistes et aux analyses d'œuvres d'art. Nous croyons que la culture est un moyen
                  important de se connecter avec le monde qui nous entoure et de comprendre les expériences des autres.
                </p>
              </li>
            </ul>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="box" data-aos="zoom-in" data-aos-delay="100">
              <span>01</span>
              <h4>Originalité</h4>
              <p>Un service original et innovant pour se démarquer de la concurrence. Faites la différence avec nous.
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box" data-aos="zoom-in" data-aos-delay="200">
              ...
              <p>Des services de qualité supérieure à des prix compétitifs. La satisfaction client est notre priorité.
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box" data-aos="zoom-in" data-aos-delay="300">
              <span>03</span>
              <h4>Sécurité</h4>
              <p>Notre site web est fier de fournir une expérience de paiement en ligne sécurisée à nos clients</p>
            </div>
          </div>
    ...
    <section id="specials" class="specials">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Top 5</h2>
          <p>Meilleurs espaces culturels visités</p>
        </div>
        ...
        <form action="forms/book-a-table.php" method="post" role="form" class="php-email-form" data-aos="fade-up"
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 form-group">
              <input type="text" name="name" class="form-control" id="name" placeholder="Prenom" data-rule="minlen:4"
            ...
            <div class="col-lg-4 col-md-6 form-group mt-3">
              <input type="text" class="form-control" name="time" id="time" placeholder="Heure" data-rule="minlen:4"
                data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
            <div class="col-lg-4 col-md-6 form-group mt-3">
              <input type="number" class="form-control" name="people" id="people" placeholder="# Nombre de personnes"
          ...
          <div class="form-group mt-3">
            <textarea class="form-control" name="message" rows="5"
              placeholder="Que souhaitez vous reserver ?"></textarea>
            <div class="validate"></div>
          </div>
          <div class="mb-3">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  Ce site web de tourisme en Tunisie créé par des jeunes entrepreneurs offre des offres incroyables et
                  une expérience utilisateur facile et agréable. Ils ont vraiment réussi à mettre en valeur toutes les
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Les jeunes entrepreneurs tunisiens ont créé un site web de tourisme qui offre une variété de
                  destinations et d'activités qui mettent en valeur la beauté de la Tunisie. Tout est facilement
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Ce site web de tourisme en Tunisie est exceptionnel, grâce à son design attrayant et à son contenu
                  fascinant. Les jeunes entrepreneurs ont créé un site qui rend la planification des vacances en Tunisie
                  un plaisir.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/testimonials-3.jpg" class="testimonial-img" alt="">
                <h3>yasmine ben mahmoud</h3>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Les jeunes entrepreneurs tunisiens ont créé un site web de tourisme qui permet aux visiteurs de
                  découvrir les sites touristiques les plus populaires de la Tunisie, ainsi que des endroits moins
                  connus mais tout aussi étonnants. Tout cela dans un design soigné et moderne.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/testimonials-4.jpg" class="testimonial-img" alt="">
                <h3>belgesm hamrouni</h3>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Ce site web de tourisme tunisien créé par des jeunes entrepreneurs offre des offres exclusives et des
                  informations utiles pour tous les voyageurs. C'est un exemple de réussite pour les jeunes
                  entrepreneurs en Tunisie qui peuvent inspirer beaucoup d'autres personnes.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
    ...
    <section id="chefs" class="chefs">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Destination </h2>
          <p>Nos meilleur destination touristique</p>
        </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="300">
              ...
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Dubai</h4>
                  <span>Emirates Arabes Unis</span>
                </div>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
