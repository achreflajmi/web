...
<div class="section-title">
<h2>Gallerie</h2>
<p>Photo de nos espaces culturels</p>
</div>
</div>
              ...
              <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-3">
                  <ul class="nav nav-tabs flex-column">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" data-bs-toggle="tab" href="#tab-5">Café culturel liberthé</a>
                    </li>
                  </ul>
                </div>
                <div class="col-lg-9 mt-4 mt-lg-0">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-5">
                      <div class="row">
                        <div class="col-lg-8 details order-2 order-lg-1">
                          <h3>Café culturel liberthé</h3>
                          <p>LiberThé est un pilier de la scène culturelle de Tunis, un lieu d"échanges intellectuel autour
                            des arts, de la culture et de la littérature...et un refuge pour les minorités, il a reçu Le Tanit
                            d’Or du meilleur espace culturel indépendant.</p>
                        </div>
                        <div class="col-lg-4 text-center order-1 order-lg-2">
