...
<head>
  ...
  <link rel="stylesheet" href="front/css/cssevents/bootstrap.css">
  ...
  <style>
     body{
        background-image: url('./images/hero-bg.png') top center;
        position:relative;
        padding:0;
...
<body>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-11 col-xl-2">
          <h1 class="mb-0 site-logo"><a href="frontstatique.php" class="text-white mb-0">Distunis</a></h1>
        </div>
  ...
  <section class="site-hero inner-page overlay" style="background-image: url(./imgassets/hero-bg.png);"
    data-stellar-background-ratio="1.5">
    <div class="container">
      <div class="row site-hero-inner justify-content-center align-items-center">
        <div class="col-md-10 text-center" data-aos="fade">
          <h1 class="heading mb-3">Evénements</h1>
    ...
    <section class="section blog-post-entry bg-light" id="next"style="background-image: url(./imgassets/hero-bg.png);">
      <div class="container">
        <div class="row">
          <?php
          $start = 0;
...
';
    ...
    <section class="section bg-image overlay" style="background-image: url('./images/hero-bg.png');">
      <div class="container">
        <div class="row align-items-center">
